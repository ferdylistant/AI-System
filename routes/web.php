...
Route::middleware(['auth'])->group(function () use ($path) {
    ...
    Route::prefix('penerbitan')->group(function () use ($path) {
        ...
        Route::post('/deskripsi/final/update-status-progress', $path.'\Penerbitan\DeskripsiFinalController@updateStatusProgress');
        Route::post('/deskripsi/final/lihat-history', $path.'\Penerbitan\DeskripsiFinalController@lihatHistoryDesfin')->name('desfin.history');
        //Deskripsi Cover
    ...
    Route::prefix('produksi')->group(function () use ($path) {
        ...
        Route::get('/proses/cetak', $path.'\Produksi\ProsesProduksiController@index')->name('proses.cetak.view');
