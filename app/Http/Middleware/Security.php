...
class Security
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (!App::environment('local')) {
            ...
            $response->headers->set('Content-Security-Policy', "base-uri 'self';connect-src 'self';default-src 'self';form-action 'self';img-src 'self';media-src 'self';object-src 'none';");
