...
class Security
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (!App::environment('local')) {
            ...
            $response->headers->set('Content-Security-Policy', "default-src *; style-src * 'unsafe-inline'; script-src * 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval' http://www.google.com;");
