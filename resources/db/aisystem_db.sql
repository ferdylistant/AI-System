...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Nov 2022 pada 10.40
...
CREATE TABLE `editing_proses` (
  ...
  `copy_editor` text COMMENT 'Array',
...
INSERT INTO `editing_proses` (`id`, `deskripsi_final_id`, `editor`, `tgl_masuk_editing`, `bulan`, `tgl_mulai_edit`, `tgl_selesai_edit`, `copy_editor`, `tgl_mulai_copyeditor`, `tgl_selesai_copyeditor`, `turun_pracetak`, `catatan`, `status`, `deleted_at`, `deleted_by`) VALUES
('d85a1255-1b27-4135-8346-54c593419f2f', '44dfe332-5755-4191-8158-e79d496e1473', '[\"fab4f858e0314d1dbf6b5b834007313e\"]', '2022-11-02 14:42:25', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Antrian', NULL, '');
