...
@section('cssRequired')
    <li <link rel="stylesheet" href="{{ url('vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
        ...
        <link rel="stylesheet"
            href="{{ url('vendors/bootstrap-datepicker/dist/css/bootstrap-datepicker.standalone.css') }}">
                                ...
                                <div class="profile-widget-description">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-md-6 mb-4">
                                            ...
                                            <input type="text" class="form-control" value="{{ $user->cabang }}"
                                                readonly>
                                        </div>
                                        <div class="form-group col-12 col-md-6 mb-4">
                                            <label>Divisi: <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" value="{{ $user->divisi }}"
                                                readonly>
                                        </div>
                                        <div class="form-group col-12 col-md-6 mb-4">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    @endcan
                                    <li class="nav-item">
                                        <a class="nav-link" id="user-log-tab" data-toggle="tab" href="#log_user"
                                            role="tab" aria-controls="log_user" aria-selected="true">User log</a>
                                    </li>
                                    @if (auth()->id() == $user->id)
                                        <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="user-status-tab" data-toggle="tab" href="#user-status"
                                            role="tab" aria-controls="user-status" aria-selected="false">User
                                            status</a>
                                    </li>
                                </ul>
