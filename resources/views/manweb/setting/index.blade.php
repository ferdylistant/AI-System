                        ...
                        <div class="row">
                            <div class="col-12 col-sm-2">
                                <div class="list-group" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action active" id="list-menu-list" data-toggle="list" href="#list-menu" role="tab" aria-controls="menu">
                                        <i class="fas fa-list"></i>&nbsp;Menu
                                    </a>
                                    <a class="list-group-item list-group-item-action" id="list-menu-bagian-list" data-toggle="list" href="#list-menu-bagian" role="tab" aria-controls="menu-bagian">
                                        <i class="fas fa-ellipsis-h"></i>&nbsp;Section
                                    </a>
                                    <a class="list-group-item list-group-item-action" id="list-permission-list" data-toggle="list" href="#list-permission" role="tab" aria-controls="permission">
                            ...
                            <div class="col-12 col-sm-10">
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="list-menu" role="tabpanel" aria-labelledby="list-menu-list">
                                        <div class="card-header">
                                            ...
                                            <div class="card-header-action">
                                                <a href="#modal-menu" class="btn btn-success" data-tipe="Menu" data-toggle="modal" data-target="#md_Menu" data-backdrop="static">Tambah</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="list-menu-bagian" role="tabpanel" aria-labelledby="list-menu-bagian-list">
                                        <div class="card-header">
                                            <h4 class="lead m-3"><i class="fas fa-ellipsis-h"></i>&nbsp;Section Menu</h4>
                                            <div class="card-header-action">
                                                <a href="#modal-section" class="btn btn-success" data-tipe="SectionMenu" data-toggle="modal" data-target="#md_SectionMenu" data-backdrop="static">Tambah</a>
                                            </div>
                                        </div>
                                        <div class="table-responsive">
                                    ...
                                    <div class="tab-pane fade" id="list-permission" role="tabpanel" aria-labelledby="list-permission-list">
                                        <div class="card-header">
                                            <h4 class="lead m-3"><i class="fas fa-user-shield"></i>&nbsp;Permission List</h4>
                                            <div class="card-header-action">
                                                <a href="#modal-permission" class="btn btn-success" data-tipe="Permission" data-toggle="modal" data-target="#md_Permission" data-backdrop="static">Tambah</a>
                                            </div>
                                        </div>
                                        <div class="table-responsive">
