        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3">Kode</label>
                    <div class="col-sm-12 col-md-9">
                        <input type="text" name="edit_kode" class="form-control" placeholder="Kode Cabang" disabled>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-9">
                        ...
                        <input type="hidden" name="edit_oldnama" class="form-control" placeholder="Nama Cabang">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3">Telepon</label>
                    <div class="col-sm-12 col-md-9">
                        <input type="text" name="edit_telp" class="form-control" placeholder="Telepon Cabang">
...
<script>
    $(function(){
        ...
        let addCabang = jqueryValidation_('#fm_AddCabang', {
            add_kode: { required: true, number: true, maxlength: 4, minlength: 4 },
            add_nama: { required: true, },
            add_telp: { number: true }
        });
