...
<head>
    ...
    <title>503 &mdash; Andi Intelligent System</title>
    ...
    <div class="container error-container">
        <div class="row  d-flex align-items-center justify-content-center">
            <div class="col-md-12 text-center">
                <h1 class="big-text">503</h1>
                <h2 class="small-text">WE'RE UNDER MAINTENANCE</h2>

            </div>
            <div class="col-md-6  text-center">
                <p>Sorry, we're under maintenance. Hang on till we get the error fixed. You may also refresh the page or try again later.</p>
