...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Penerimaan Buku Rekondisi</h1>
        </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped dt-responsive" id="tb_penerimaanRekondisi" style="width:100%">
                                </table>
                            </div>
                        </div>
                    </div>
...
@section('jsNeeded')
    <script src="{{ url('js/penjualan_stok/penerimaan_rekondisi.js') }}"></script>
@endsection
