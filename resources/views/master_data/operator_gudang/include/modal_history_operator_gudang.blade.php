<!-- Modal HistoryFormatBuku -->
<div id="md_OperatorGudangHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModalOperatorGudang"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="titleModalOperatorGudang"><i class="fas fa-history"></i></h5>
