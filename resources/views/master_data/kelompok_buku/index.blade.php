...
@section('content')
            ...
            @if (Gate::allows('do_create', 'buat-kelompok-buku'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <button id="btn_AddKelompokBuku" class="btn btn-success" data-toggle="modal"
                            data-target="#md_AddKelompokBuku" data-backdrop="static">Tambah</button>
                        <a href="{{ route('kb.telah_dihapus') }}" class="btn btn-danger">Kelompok Buku Telah Dihapus</a>
                    </div>
                </div>
            @endif
        </div>
    ...
    <!-- Modal Kelompok Buku -->
    @include('master_data.kelompok_buku.include.modal_add_kelompok_buku')
    @include('master_data.kelompok_buku.include.modal_edit_kelompok_buku')
    @include('master_data.kelompok_buku.include.modal_history_kelompok_buku')
@endsection
