...
<div id="md_OperatorMesinHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModalOperatorMesin"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="titleModalOperatorMesin"><i class="fas fa-history"></i></h5>
