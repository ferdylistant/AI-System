...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            @if (Gate::allows('do_create', 'buat-jenis-mesin'))
    ...
    <!-- Modal Format Buku -->
    @include('master_data.jenis_mesin.include.modal_add_jenis_mesin')
    @include('master_data.jenis_mesin.include.modal_edit_jenis_mesin')
    @include('master_data.jenis_mesin.include.modal_history_jenis_mesin')
@endsection
...
@section('jsNeeded')
    <script src="{{ url('js/master_data/jenis_mesin.js') }}"></script>
@endsection
