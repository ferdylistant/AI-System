...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Supplier</h1>
            @if (Gate::allows('do_create', 'tambah-supplier'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <button id="btn_AddSupplier" class="btn btn-success" data-toggle="modal"
                            data-target="#md_Supplier" data-backdrop="static" data-type="add">Tambah</button>
                        <a href="{{ route('supplier.telah_dihapus') }}" class="btn btn-danger">Supplier Telah Dihapus</a>
                    </div>
                </div>
            @endif
        </div>
    ...
    <!-- Modal Supplier -->
    @include('master_data.supplier.include.modal_supplier')
@endsection
