...
@section('content')
    ...
    <!-- Modal Platform Digital -->
    @include('master_data.platform_digital.include.modal_add_platform')
    @include('master_data.platform_digital.include.modal_edit_platform')
    @include('master_data.platform_digital.include.modal_history_platform')
@endsection
