...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Data Rack Yang Telah Dihapus</h1>
        </div>
...
@section('jsNeeded')
    <script>
        $(function() {
            let tableDelRackList = $('#tb_RackList').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                language: {
                ...
                ajax: {
                    url: "{{ url('master/rack-list/rack-list-telah-dihapus') }}",
                },
                columns: [{
                        data: 'no',
                        name: 'no',
            ...
            $(document).ready(function() {
                function ajaxRestoreRackList(data) {
                    $.ajax({
                        type: "POST",
                        url: window.location.origin +
                            "/master/rack-list/restore",
                        data: data,
                        beforeSend: function() {
                            $(".btn_ResRackList")
                                .prop("disabled", true)
                ...
                $(document).on("click", ".btn_ResRackList", function(e) {
