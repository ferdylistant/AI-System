...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Data Master Harga Jual Yang Telah Dihapus</h1>
        </div>
...
@section('jsNeeded')
    <script>
        $(function() {
            let tableDelHargaJual = $('#tb_HargaJual').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                language: {
                ...
                ajax: {
                    url: "{{ url('master/harga-jual/harga-jual-telah-dihapus') }}",
                },
                columns: [{
                        data: 'no',
                        name: 'no',
            ...
            $(document).ready(function() {
                function ajaxRestoreHargaJual(data) {
                    $.ajax({
                        type: "POST",
                        url: window.location.origin +
                            "/master/harga-jual/restore",
                        data: data,
                        beforeSend: function() {
                            $(".btn_ResHargaJual")
                                .prop("disabled", true)
                ...
                $(document).on("click", ".btn_ResHargaJual", function(e) {
