...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Master Harga Jual</h1>
            @if (Gate::allows('do_create', 'buat-harga-jual'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <button id="btn_AddHargaJual" class="btn btn-success" data-toggle="modal" data-target="#md_AddHargaJual"
                            data-backdrop="static">Tambah</button>
                        <a href="{{ route('hj.telah_dihapus') }}" class="btn btn-danger">Data Harga Jual Telah Dihapus</a>
                    </div>
                </div>
            @endif
        </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped" id="tb_HargaJual" style="width:100%">
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Format Buku -->
    @include('master_data.harga_jual.include.modal_add_harga_jual')
    @include('master_data.harga_jual.include.modal_edit_harga_jual')
    @include('master_data.harga_jual.include.modal_history_harga_jual')
@endsection
...
@section('jsNeeded')
    <script src="{{ url('js/master_data/harga_jual.js') }}"></script>
@endsection
