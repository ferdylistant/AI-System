...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Sub Golongan</h1>
            @if (Gate::allows('do_create', 'tambah-sub-golongan'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <button id="btn_AddSGolongan" class="btn btn-success" data-toggle="modal"
                            data-target="#md_SGolongan" data-backdrop="static" data-type="add">Tambah</button>
                        <a href="{{ route('sgolongan.telah_dihapus') }}" class="btn btn-danger">Sub Golongan Telah Dihapus</a>
                    </div>
                </div>
            @endif
        </div>
    ...
    <!-- Modal Sub Type -->
    @include('master_data.sub_golongan.include.modal_sub_golongan')
@endsection
...
@section('jsNeeded')
    <script src="{{ url('js/master_data/sgolongan.js') }}"></script>
@endsection
