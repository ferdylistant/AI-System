...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Golongan</h1>
            @if (Gate::allows('do_create', 'buat-golongan'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <button id="btn_AddGolongan" class="btn btn-success" data-toggle="modal"
                            data-target="#md_Golongan" data-backdrop="static" data-type="add">Tambah</button>
                        <a href="{{ route('golongan.telah_dihapus') }}" class="btn btn-danger">Golongan Telah Dihapus</a>
                    </div>
                </div>
            @endif
        </div>
    ...
    <!-- Modal Golongan -->
    @include('master_data.golongan.include.modal_golongan')
@endsection
...
@section('jsNeeded')
    <script src="{{ url('js/master_data/golongan.js') }}"></script>
@endsection
