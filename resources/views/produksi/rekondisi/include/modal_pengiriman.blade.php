<!-- Modal -->
<div class="modal fade" id="modalPengirimanRekondisi" tabindex="-1" role="dialog" aria-labelledby="modalPengirimanTitle" aria-hidden="true">
                  ...
                  <div class="section">
                      <div class="section-body">
                          <div class="d-flex justify-content-between">
                              <div class="col-auto">
                                  <h6 class="section-title" id="sectionTitle">Pengiriman ke gudang</h6>
                              </div>
