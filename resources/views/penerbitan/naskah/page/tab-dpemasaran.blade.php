    ...
    <div class="row">
        <div class="col-12 mb-3">
            <h5 class="section-title">Penilaian oleh: <a class="text-primary text-decoration-none"
                    href="{{ url('manajemen-web/user/' . $pn_pemasaran->created_by) }}"><b>{{ \Str::ucfirst($nama_direktur) }}</b></a>
            </h5>
            @if ($history)
                <a class="btn btn-sm btn-dark float-right btn-history-penilaian" href="javascript:void(0)"
                    data-toggle="modal" data-target="#modalHistoryPenilaian" data-pic="DPM"
        ...
        <div class="form-group col-12 mb-4">
            ...
            <input type="text" class="form-control" name="pn3_potensi_dana" value="{{ $pn_pemasaran->potensi_dana }}"
                placeholder="Potensi Dana" readonly>
            <div id="err_pn3_potensi_dana"></div>
        </div>
        <div class="form-group col-12">
            <label class="d-block">DS / TB: <span class="text-danger">*</span></label>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="cb_{{ $pn_pemasaran->ds_tb }}"
                    value="{{ $pn_pemasaran->ds_tb }}" checked='' disabled>
