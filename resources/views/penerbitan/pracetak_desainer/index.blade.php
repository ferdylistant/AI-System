...
<section class="section">
    <div class="section-header">
        <h1>Data Penerbitan Pracetak Desainer</h1>
    </div>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-auto">
                                <span class="badge badge-warning"><i class="fas fa-database"></i> Total data proses pracetak desainer: <b>{{$count}}</b></span>
                            </div>
                        </div>
                        <div class="col-12 table-responsive">
                            <table id="tb_PraDes" class="table table-striped dt-responsive" style="width:100%">
                            </table>
                        </div>
                    </div>
                </div>
...
<div id="md_UpdateStatusPracetakDesainer" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Update Status Progress Pracetak Desainer</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="fm_UpdateStatusPraDes">
...
<div id="md_PraDesHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModalPraDes" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="titleModalPraDes"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body example-1 scrollbar-deep-purple bordered-deep-purple thin">
                <div class="tickets-list" id="dataHistoryPraDes">
    ...
    $(function() {
        ...
        let tableDesCover = $('#tb_PraDes').DataTable({
            ...
            columns: [
                ...
                { data: 'desainer', name: 'desainer', title: 'Desainer'},
                { data: 'tgl_masuk_cover', name: 'tgl_masuk_cover', title: 'Tgl Masuk'},
...
<script>
    $('#tb_PraDes').on('click','.btn-history',function(e){
        ...
        $.post("{{route('prades.history')}}", {id: id}, function(data){
            $('#titleModalPraDes').html('<i class="fas fa-history"></i>&nbsp;History Progress Pracetak Desainer "'+judul+'"');
...
<script src="{{url('js/update_progress_prades.js')}}"></script>
@endsection
