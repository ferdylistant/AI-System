...
@section('content')
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-auto">
                                    <span class="badge badge-warning"><i class="fas fa-database"></i> Total data proses
                                        pracetak desainer: <b>{{ $count }}</b></span>
                                </div>
                            </div>
    ...
    <div id="md_UpdateStatusPracetakDesainer" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModal"
        aria-hidden="true">
    ...
    <div id="md_PraDesHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModalPraDes"
        aria-hidden="true">
