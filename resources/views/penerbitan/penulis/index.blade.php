    ...
    $(function(){
        let tablePenulis = $('#tb_Penulis').DataTable({
            ...
            ajax: {
                ...
                data: {"request_": "table-penulis"}
            },
            columns: [
                { data: 'ktp', name: 'ktp', title: 'KTP' },
                { data: 'nama', name: 'nama', title: 'Nama' },
                { data: 'email', name: 'email', title: 'Email'},
                { data: 'ponsel_domisili', name: 'ponsel_domisili', title: 'Ponsel'},
        ...
        function ajaxDeletePenulis(data) {
            $.ajax({
                ...
                success: function(result) {
                    ...
                    swal('Data penulis '+data.nama+', berhasil dihapus', {icon: 'success'});
                },
                error: function(err) {
                    swal('Data penulis '+data.nama+' gagal dihapus!', {icon: 'error'});
                },
                complete: function() {
        ...
        $('#tb_Penulis').on('click', '.btn_DelPenulis', function(e) {
            ...
            .then((confirm_) => {
                if (confirm_) {
                    ajaxDeletePenulis({id: id, nama: nama});
                }
            });
        })
    })
