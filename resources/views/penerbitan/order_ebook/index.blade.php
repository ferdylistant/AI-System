...
@section('content')
                            ...
                            <div class="row justify-content-between mb-3">
                                ...
                                <div class="col-auto pb-3">
                                    <span class="badge badge-warning"
                                        ...
                                        e-book: <b id="countData">0</b></span>
                                </div>
                            </div>
    ...
    <div id="md_UpdateStatusOrderEbook" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="fm_UpdateStatusOrderEbook">
    ...
    <div id="md_OrderEbookHistory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="titleModalOrderEbook"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-header bg-light">
                    <h5 class="modal-title" id="titleModalOrderEbook"></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body example-1 scrollbar-deep-purple bordered-deep-purple thin">
                    <div class="tickets-list" id="dataHistoryOrderEbook">
