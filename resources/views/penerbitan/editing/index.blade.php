                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-auto">
                                <span class="badge badge-warning"><i class="fas fa-database"></i> Total data editing naskah: <b>{{$count}}</b></span>
                            </div>
                        </div>
    ...
    $(function() {
        ...
        let tableDesProduk = $('#tb_Editing').DataTable({
            ...
            columns: [
                ...
                { data: 'tgl_masuk_editing', name: 'tgl_masuk_editing', title: 'Tgl Masuk Editing'},
                { data: 'pic_prodev', name: 'pic_prodev', title: 'PIC Prodev'},
                { data: 'editor', name: 'editor', title: 'Editor'},
...
<script>
    $('#tb_Editing').on('click','.btn-history',function(e){
        ...
        $.post("{{route('editing.history')}}", {id: id}, function(data){
            $('#titleModalEditing').html('<i class="fas fa-history"></i>&nbsp;History Perubahan Naskah "'+judul+'"');
