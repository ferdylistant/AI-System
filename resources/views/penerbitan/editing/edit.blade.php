                    ...
                    <form id="fup_editingProses">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-active text-right">{{ is_null($data->isi_warna)?'-':$data->isi_warna }}</td>
                                                </tr>
                                                <tr>
                                                    <th class="table-secondary" style="width: 25%">Isi Huruf:</th>
                                                    <td class="table-active text-right">{{ is_null($data->isi_huruf)?'-':$data->isi_huruf }}</td>
                                                </tr>
                                                <tr>
                                                    <th class="table-secondary" style="width: 25%">Sinopsis:</th>
                                                    <td class="table-active text-right">{{is_null($data->sinopsis)?'-':$data->sinopsis}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-active text-left">
                                                        <select name="editor[]" class="form-control select-editor-editing" multiple="multiple" required>
                                                            ...
                                                            <option value="{{$edList->id}}">{{$edList->nama}}&nbsp;&nbsp;</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    @else
                                                    ...
                                                    <td class="table-active text-left" id="editorColInput" hidden>
                                                        <div class="input-group">
                                                            <select name="editor[]" class="form-control select-editor-editing" multiple="multiple">
                                                                ...
                                                                @endif
                                                                <option value="{{$edList->id}}" {{$sel}}>{{$edList->nama}}&nbsp;&nbsp;</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="input-group-append">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-active text-left">
                                                        {{$dis = '';}}
                                                        @if (is_null($data->editor) && is_null($data->tgl_selesai_edit))
                                                        <span class="text-danger"><i class="fas fa-exclamation-circle"></i> Belum bisa melanjutkan proses copy editing, proses editing belum selesai.</span>
                                                        ...
                                                        <select name="copy_editor[]" class="form-control select-copyeditor" multiple="multiple" {{$dis}} required>
                                                            ...
                                                            <option value="{{$cpeList->id}}">{{$cpeList->nama}}&nbsp;&nbsp;</option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td class="table-active text-left" id="copyEditorColInput" hidden>
                                                        <div class="input-group">
                                                            <select name="copy_editor[]" class="form-control select-copyeditor" multiple="multiple">
                                                                ...
                                                                {{$sel = ' selected="selected" ';}}
                                                                @endif
                                                                <option value="{{$cpeList->id}}" {{$sel}}>{{$cpeList->nama}}&nbsp;&nbsp;</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="input-group-append">
                                                                <button type="button" class="btn btn-outline-danger batal_edit_editor text-danger align-self-center" data-toggle="tooltip" title="Batal Edit"><i class="fas fa-times"></i></button>
                        ...
                        <div class="card-footer text-right">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" name="proses" class="custom-control-input" id="prosesKerja" {{$data->proses=='1'?'checked':''}}>
