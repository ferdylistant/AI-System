                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="table-active text-right">{{ is_null($data->sub_judul_final)?'-':$data->sub_judul_final }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if (!is_null($data->isi_warna))
                                                                ...
                                                                <td class="table-active text-left" id="isiWarnaColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <select name="isi_warna"
                                                                            class="form-control select-isi-warna">
                                                                            <option label="Pilih isi warna"></option>
                                                                            @foreach ($isi_warna as $i)
                                                                                <option value="{{ $i }}"
                                                                                    {{ $data->isi_warna == $i ? 'Selected' : '' }}>
                                                                                    {{ $i }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        <div class="input-group-append">
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger batal_edit_isi_warna text-danger align-self-center"
                                                                                data-toggle="tooltip"
                                                                                title="Batal Edit"><i
                                                                                    class="fas fa-times"></i></button>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if (!is_null($data->isi_huruf))
                                                                ...
                                                                <td class="table-active text-left" id="isiHurufColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <input type="text" name="isi_huruf"
                                                                            class="form-control"
                                                                            value="{{ $data->isi_huruf }}"
                                                                            placeholder="Isi huruf">
                                                                        <div class="input-group-append">
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger batal_edit_isi_huruf text-danger"
                                                                                data-toggle="tooltip"
                                                                                title="Batal Edit"><i
                                                                                    class="fas fa-times"></i></button>
                                                                        </div>
                                                            ...
                                                            @else
                                                                <td class="table-active text-left">
                                                                    <input type="text" name="isi_huruf"
                                                                        class="form-control" placeholder="Isi huruf">
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <div class="input_fields_wrap">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" name="bullet[]"
                                                                                placeholder="Bullet" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            @else
                                                                <td class="table-active text-right" id="bulletCol">
                                                                    ...
                                                                    @endforeach
                                                                    <p class="text-small">
                                                                        <a href="javascript:void(0)" id="bulletButton"><i
                                                                                class="fa fa-pen"></i>&nbsp;Add / Edit</a>
                                                                    </p>
                                                                </td>
                                                                <td class="table-active text-left" id="bulletColInput"
                                                                    hidden>
                                                                    <div class="input_fields_wrap">
                                                                        <button
                                                                            class="add_field_button btn btn-outline-primary mb-1"><i
                                                                            ...
                                                                            Fields</button>
                                                                        <button
                                                                            class="btn btn-outline-danger batal_edit_bullet text-danger align-self-center mb-1"
                                                        ...
                                                        <tr>
                                                            <th class="table-secondary" style="width: 25%">Usulan Setter:
                                                            </th>
                                                            @if (!is_null($data->setter))
                                                                <td class="table-active text-right" id="setterCol">
                                                                    {{ $nama_setter->nama }}
                                                                    <p class="text-small">
                                                                        <a href="javascript:void(0)" id="setterButton"><i
                                                                                class="fa fa-pen"></i>&nbsp;Edit</a>
                                                                    </p>
                                                                </td>
                                                                <td class="table-active text-left" id="setterColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <select name="setter"
                                                                            class="form-control select-setter">
                                                                            <option label="Pilih setter"></option>
                                                                            @foreach ($setter as $s)
                                                                                <option value="{{ $s->id }}"
                                                                                    {{ $data->setter == $s->id ? 'Selected' : '' }}>
                                                                                    {{ $s->nama }}&nbsp;&nbsp;
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                        <div class="input-group-append">
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger batal_edit_setter text-danger align-self-center"
                                                                                data-toggle="tooltip"
                                                                                title="Batal Edit"><i
                                                                                    class="fas fa-times"></i></button>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            <th class="table-secondary" style="width: 25%">Usulan
                                                                Korektor:</th>
                                                            @if (!is_null($data->korektor))
                                                                ...
                                                                <td class="table-active text-left" id="korektorColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <select name="korektor"
                                                                            class="form-control select-korektor">
                                                                            <option label="Pilih korektor"></option>
                                                                            @foreach ($korektor as $s)
                                                                                <option value="{{ $s->id }}"
                                                                                    {{ $data->korektor == $s->id ? 'Selected' : '' }}>
                                                                                    {{ $s->nama }}&nbsp;&nbsp;
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if (!is_null($data->sinopsis))
                                                                ...
                                                                <td class="table-active text-left" id="sinopsisColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <textarea name="sinopsis" class="form-control">{{ $data->sinopsis }}</textarea>
                                                                        <div class="input-group-append">
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger batal_edit_sinopsis text-danger"
                                                                                data-toggle="tooltip"
                                                                                title="Batal Edit"><i
                                                                                    class="fas fa-times"></i></button>
                                                                        </div>
                                                            ...
                                                            @else
                                                                <td class="table-active text-right" id="sinopsisCol">
                                                                    <a href="javascript:void(0)" id="sinopsisButton"><i
                                                                            class="fa fa-plus"></i>&nbsp;Tambahkan</a>
                                                                </td>
                                                                <td class="table-active text-left" id="sinopsisColInput"
                                                                    hidden>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="table-secondary" style="width: 25%">Jumlah halaman
                                                            asli: <span class="text-danger">*</span></th>
                                                        <td class="table-active text-right">
                                                    ...
                                                    <tr>
                                                        <th class="table-secondary" style="width: 25%">Usulan Korektor:
                                                        </th>
                                                        <td class="table-active text-right">
                                                            @if (!is_null($data->korektor))
                                                                {{ $nama_korektor->nama }}
