                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header justify-content-between">
                            <h4 class="section-title">Data Detail Pracetak Setter
                            </h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            @switch($data->jalur_buku)
                                                ...
                                                @default
                                                    @php $jb = 'MoU-Reguler' @endphp
                                                @break
                                            @endswitch
                                            @if (Gate::allows('do_create', 'ubah-atau-buat-editing-' . $jb))
                                                @if ($data->status == 'Proses' && $data->proses == '0')
                                                    <div class="alert alert-warning alert-dismissible fade show"
                                                        style="border-left: solid black;" role="alert">
                                                        <strong>Status {{$data->status}}!</strong> Anda belum mendelegasikan tugas kepada Editor.
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($data->status == 'Revisi')
                                                                ...
                                                                @endphp
                                                            @endif
                                                            <th class="table-secondary" style="width: 25%">Editor: <span
                                                                    class="text-danger">*{{ $cannotEdit }}</span></th>
                                                            @if (is_null($data->editor) || $data->editor == '[]' || $data->editor == '[null]')
                                                                <td class="table-active text-left">
                                                                    <select name="editor[]"
                                                                        class="form-control select-editor-editing"
                                            ...
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="sub_judul_final"
                                                            value="{{ $data->sub_judul_final }}">
                                                        <td class="table-active text-right">
                                                            {{ is_null($data->sub_judul_final) ? '-' : $data->sub_judul_final }}
                                                        </td>
                                                    </tr>
