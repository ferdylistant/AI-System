                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="table-active text-right">
                                                                {{ is_null($data->sinopsis) ? '-' : $data->sinopsis }}</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            @if (is_null($data->copy_editor) || $data->copy_editor == '[]')
                                                                <td class="table-active text-left">
                                                                    ...
                                                                    @if (is_null($data->tgl_selesai_edit))
                                                                        ...
                                                                        <span
                                                                            hidden>{{ $dis = 'disabled="disabled"' }}</span>
                                                                    @endif
                                                                    <select name="copy_editor[]"
                                                                        class="form-control select-copyeditor"
                                                                ...
                                                                <td class="table-active text-right" id="copyEditorCol">
                                                                    ...
                                                                    <p class="text-small">
                                                                        <a href="javascript:void(0)"
                                                                            id="copyEditorButton"><i
                                                                                class="fa fa-pen"></i>&nbsp;Add / Edit</a>
                                                                    </p>
                                                                </td>
                                                                <td class="table-active text-left" id="copyEditorColInput"
                                                                    hidden>
                                                                    <div class="input-group">
                                                                        <select name="copy_editor[]"
                                                                            class="form-control select-copyeditor"
