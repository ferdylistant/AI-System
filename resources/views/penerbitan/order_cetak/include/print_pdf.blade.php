    ...
    <body>
        <div class="container-fluid">
            ...
            <!-- <img src="https://2.bp.blogspot.com/-26OOkCpYY7w/XBSmEG3LxSI/AAAAAAAAB_M/Gm7jUOqIBgwbu1eiOAjempNujA7CB48wgCK4BGAYYCw/s400/Lowongan%2BKerja%2BPenerbit%2BAndi%2BKaltim.jpg"
                    class="img-fluid mx-auto d-block filter-img mb-1" width="70" height="70" alt=""> -->
            <center class="mb-2">

                <small>PENERBIT ANDI</small>
                <br />
                <small
                    >Jl. Beo 36-40 Telp. (0274) 561881, Fax. 588282 E-Mail:
                    penerbitan@andipublisher.com; Yogyakarta 55281</small
                >
            </center>
            <h2 class="font-weight-bold">
                <u>ORDER CETAK BUKU ROHANI</u>
            </h2>
            <!-- <hr class="style-eight"> -->
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="flex-column align-items-start mb-4">
                            <span class="float-left">Kode Order&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$data->kode_order}}</span>
                            <span class="float-right">Status Cetak: {{$data->status_cetak}}</span>
                    </div>
                    <div class="flex-column align-items-start ml5-min">
                        <div class="d-flex w-100 justify-content-between">
                            <span class="mb-1">Judul Buku&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$data->judul_final}}</span>
                        </div>
                    </div>
                    <div class="flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <span class="mb-1">Sub Judul&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$data->sub_judul_final}}</span>
                        </div>
                    </div>
                    <div class="flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <span class="mb-1">Penulis&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$data->penulis}}</span>
                        </div>
                    </div>
                    <div class="flex-column align-items-start mb-4">
                        <span class="float-left">Kode Order: 23-0001</span>
                        <span class="float-right">Status Cetak: Buku Baru</span>
                </div>
            </div>
        </div>
    </body>
