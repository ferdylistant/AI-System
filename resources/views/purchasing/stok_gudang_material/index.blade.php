...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Stok Gudang Material</h1>
            @if (Gate::allows('do_create', 'tambah-stok-gudang-material'))
                <div class="section-header-button">
                    <div class="card-header-action">
                        <a href="{{ route('sgm.create') }}" class="btn btn-success">Tambah Permintaan</a>
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped" id="tb_Stok" style="width:100%">
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Stok -->
    @include('purchasing.stok_gudang_material.include.modal_stok')
@endsection
...
@section('jsNeeded')
    <script src="{{ url('js/purchasing/stok_gudang_material.js') }}"></script>
@endsection
