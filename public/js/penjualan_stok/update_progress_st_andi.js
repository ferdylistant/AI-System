$(document).ready(function () {
    var baseUrl = window.location.origin + "/penjualan-stok/gudang/stok-buku/andi";
        ...
        buttons: [
            ...
            'spacer',
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    $.ajax({
                        url: baseUrl + '/export-all?penulis=' + penulis + '&imprint=' + imprint + '&min=' + min + '&max=' + max,
                        type: 'GET',
                        cache: false,
                        beforeSend: function () {
                            $("#overlay").fadeIn(300);
    ...
    $("#penulis")
        .select2({
            placeholder: 'Penulis...',
            ajax: {
                url: baseUrl + "?request_type=select-filter-penulis",
                type: "GET",
    ...
    $("#imprint")
        .select2({
            placeholder: 'Imprint...',
            ajax: {
                url: baseUrl + "?request_type=select-filter-imprint",
                type: "GET",
                data: function (params) {
                    var queryParameters = {
                        term: params.term
    ...
    function ajaxModalRack(stok_id, total_stok, judul, cardWrap) {
        $.ajax({
            url: baseUrl + '?request_type=show-modal-rack',
            type: 'GET',
            data: {
                stok_id: stok_id,
            ...
            success: function (result) {
                ...
                $('.select-rack').select2({
                    ...
                    ajax: {
                        url: baseUrl + '?request_type=select-rack',
                        type: "GET",
                        data: function (params) {
                            var queryParameters = {
                                term: params.term
                ...
                $('.select-optgudang').select2({
                    ...
                    ajax: {
                        url: baseUrl + '?request_type=select-operator-gudang',
                        type: "GET",
                        data: function (params) {
                            var queryParameters = {
                                term: params.term
    ...
    function ajaxModalDetailRack(rack_id, stok_id, rack_data_id, nama_rak, cardWrap) {
        $.ajax({
            url: baseUrl + '?request_type=show-modal-rack-detail',
            type: 'GET',
            data: {
                rack_id: rack_id,
                stok_id: stok_id,
    ...
    function ajaxModalEditHarga(stok_id, naskah_id, judul, kode_sku, cardWrap) {
        $.ajax({
            url: baseUrl + '?request_type=show-modal-editharga',
            type: 'GET',
            data: {
                stok_id: stok_id,
                naskah_id: naskah_id,
            ...
            cache: false,
            success: (res) => {
                cardWrap.find('#sectionTitle').html(judul.charAt(0).toUpperCase() + judul.slice(1) + ' <small>(' + kode_sku + ')</small>').trigger('change');
                cardWrap.find('#contentForm').html(res).trigger('change');
            },
            error: function (err) {
                // console.log(err);
                notifToast('error', err.statusText);
    ...
    function ajaxEditHargaJual(data) {
        ...
        $.ajax({
            url: baseUrl + "?request_type=edit-harga-jual",
            type: 'POST',
            data: el,
            processData: false,
            contentType: false,
    ...
    function ajaxPermohonanRekondisi(data) {
        ...
        $.ajax({
            url: baseUrl + "?request_type=permohonan-rekondisi",
            type: 'POST',
    ...
    function ajaxModalPermohonanRekondisi(stok_id, total_stok, cardWrap) {
        $.ajax({
            url: baseUrl + '?request_type=modal-permohonan-rekondisi',
            type: 'GET',
            data: {
                stok_id: stok_id,
                total_stok: total_stok,
    ...
    function ajaxModalHistoryRack(rack_data_id, stok_id, cardWrap) {
        $.ajax({
            url: baseUrl + "?request_type=show-modal-rack-history",
            type: 'GET',
            data: {
                rack_data_id: rack_data_id,
                stok_id: stok_id,
    ...
    function ajaxModalPindahRack(rack_data_id, stok_id, cardWrap) {
        $.ajax({
            url: baseUrl + "?request_type=show-modal-rack-move",
            type: 'GET',
            data: {
                rack_data_id: rack_data_id,
                stok_id: stok_id,
            ...
            success: (res) => {
                ...
                $('.select-rack-move').select2({
                    placeholder: 'Pilih rak',
                    ajax: {
                        url: baseUrl + '?request_type=select-rack-for-move&rack_id=' + res.rack_id,
                        type: "GET",
                        data: function (params) {
                            var queryParameters = {
                                term: params.term
    ...
    function ajaxStokStatus(id, value) {
        $.ajax({
            url: baseUrl + "?request_type=status-on-off",
            type: 'POST',
    ...
    function ajaxPindahRak(data) {
        ...
        $.ajax({
            url: baseUrl + "?request_type=pindah-rack",
            type: 'POST',
            data: datapost,
            processData: false,
            contentType: false,
    ...
    function ajaxAddRak(data) {
        ...
        $.ajax({
            url: baseUrl + '?request_type=add-data-rack',
            type: 'POST',
            data: new FormData(el),
            processData: false,
            contentType: false,
    ...
    function ajaxEditRak(data) {
        ...
        $.ajax({
            url: baseUrl + '?request_type=edit-data-rack',
            type: 'POST',
            data: new FormData(el),
            processData: false,
            contentType: false,
    ...
    function ajaxDeleteRak(element, nama_rak, id, rack_id, stok_id) {
        $.ajax({
            url: baseUrl + '?request_type=delete-data-rack',
            type: 'POST',
            data: {
                id: id,
                nama_rak: nama_rak,
    ...
    $('#modalEditHarga').on({
        'shown.bs.modal': function (e) {
            let stok_id = $(e.relatedTarget).data('id'),
                ...
                cardWrap = $(this);
            ajaxModalEditHarga(stok_id, naskah_id, judul, kode_sku, cardWrap);
        },
        ...
        submit: function (e) {
            ...
            swal({
                ...
                if (confirm_) {
                    ajaxEditHargaJual($('#modalEditHarga #fm_editHarga'));
                }
            });
        }
    });
    $('#modalRack').on({
        'shown.bs.modal': function (e) {
            ...
            judul = $(e.relatedTarget).data('judul')
            cardWrap = $(this);
            ajaxModalRack(stok_id, total_stok, judul, cardWrap);
        },
        'hidden.bs.modal': function (e) {
            $(this).find("form").trigger("reset");
            $(this).addClass("modal-progress");
        ...
        submit: function (e) {
            ...
            if ($('#modalRack #fm_addRak').valid()) {
                swal({
                    ...
                    if (confirm_) {
                        ajaxAddRak($('#modalRack #fm_addRak'));
                    }
                });
            }
        }
    ...
    $('#modalDetailRack').on({
        'show.bs.modal': function (e) {
            let rack_id = $(e.relatedTarget).data('rack_id'),
                ...
                cardWrap = $(this);
            ajaxModalDetailRack(rack_id, stok_id, rack_data_id, nama_rak, cardWrap);
        },
        'hidden.bs.modal': function (e) {
            $(this).addClass("modal-progress");
        }
    ...
    $('#modalDetailRack').on("click", "#btnEditRack", function (e) {
        ...
        let rack_id = $(this).data('rack_id'),
            ...
            cardWrap = $("#modalEditRack");
        $.ajax({
            url: baseUrl + '?request_type=show-modal-rack-edit',
            type: 'GET',
            cache: false,
            data: {
                rack_id: rack_id,
    ...
    $("#modalEditRack").on({
        ...
        submit: function (e) {
            e.preventDefault();
            if ($('#modalEditRack #fm_EditRack').valid()) {
                swal({
                    ...
                    if (confirm_) {
                        ajaxEditRak($('#modalEditRack #fm_EditRack'));
                    }
                });
            }
        }
    ...
    $('#modalAktivitasRak').on('shown.bs.modal', function (e) {
        ...
        let tabelStok = $('#tb_aktivitasRak').DataTable({
            ...
            ajax: {
                url: baseUrl + "?request_type=table-riwayat-aktivitas-rak",
                data: {
                    stok_id: stok_id
                }
            },
    ...
    $('#md_PindahRak').on({
        'shown.bs.modal': function (e) {
            ...
            let rack_data_id = $(e.relatedTarget).data('rack_data_id'),
                stok_id = $(e.relatedTarget).data('stok_id'),
                cardWrap = $(this);
            ajaxModalPindahRack(rack_data_id, stok_id, cardWrap);
        },
        'hidden.bs.modal': function (e) {
            $(this).addClass("modal-progress");
            pindahRak.resetForm();
        ...
        submit: function (e) {
            e.preventDefault();
            if ($("#md_PindahRak #fm_PindahRak").valid()) {
                swal({
                    ...
                    if (confirm_) {
                        ajaxPindahRak($("#md_PindahRak #fm_PindahRak"));
                    }
                });
            }
        }
    ...
    $('#md_HistoryRack').on({
        'shown.bs.modal': function (e) {
            ...
            let rack_data_id = $(e.relatedTarget).data('rack_data_id'),
                stok_id = $(e.relatedTarget).data('stok_id'),
                cardWrap = $(this);
            ajaxModalHistoryRack(rack_data_id, stok_id, cardWrap);
        },
        'hidden.bs.modal': function (e) {
            $(this).addClass("modal-progress");
    ...
    $(".load-more").click(function (e) {
        ...
        $.ajax({
            url:
                baseUrl + "?request_type=show-modal-rack-history",
            data: {
                rack_data_id: id,
                page: page,
            },
    ...
    $('#modalPermohonanRekondisi').on({
        'shown.bs.modal': function (e) {
            ...
            let stok_id = $('[name="stok_id"]').val(),
                ...
                cardWrap = $(this);
            ajaxModalPermohonanRekondisi(stok_id, total_stok, cardWrap);
        },
        'hidden.bs.modal': function (e) {
            $(this).addClass("modal-progress");
        ...
        submit: function (e) {
            e.preventDefault();
            if ($('#modalPermohonanRekondisi #fm_PermohonanRekondisi').valid()) {
                ...
                swal({
                    ...
                    if (confirm_) {
                        ajaxPermohonanRekondisi($('#modalPermohonanRekondisi #fm_PermohonanRekondisi'));
                    }
                });
            } else {
