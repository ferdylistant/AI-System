...
$(document).ready(function () {
    ...
    $(".batal_edit_desback").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_desfront").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_jilid").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_finishing").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_tipografi").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_warna").click(function (e) {
        //user click on remove text
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $(".batal_edit_contoh_cover").click(function (e) {
        //user click on remove text
        e.preventDefault();
