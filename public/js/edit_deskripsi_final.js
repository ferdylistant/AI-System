...
$(document).ready(function() {
    ...
    $('.batal_edit_kertas_isi').click(function(e){ //user click on remove text
		e.preventDefault();
...
$(document).ready(function() {
    ...
    $('.batal_edit_isi_warna').click(function(e){ //user click on remove text
		e.preventDefault();
...
$(document).ready(function() {
    ...
    $('.batal_edit_ukuran_asli').click(function(e){ //user click on remove text
		e.preventDefault();
...
$(document).ready(function() {
    ...
    $('.batal_edit_isi_huruf').click(function(e){ //user click on remove text
		e.preventDefault();
...
$(document).ready(function() {
    ...
    $('.batal_edit_setter').click(function(e){ //user click on remove text
		e.preventDefault();
